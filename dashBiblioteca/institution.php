...
<div class="container-fluid">
    ...
    <ul class="nav nav-tabs nav-justified" role="tablist">
        ...
        <li role="presentation"><a href="#facultades" aria-controls="facultades" role="tab" data-toggle="tab">Facultades</a></li>
...
<div class="tab-content">
    ...
    <!-- SECCIONES PESTAÑA -->
    <div role="tabpanel" class="tab-pane fade" id="facultades">
        <?php incluirSeccionAdministracion('facultades'); ?>
    </div>
</div>
