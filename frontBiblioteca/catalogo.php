...
<!-- Menu Section -->
    ...
    <section id="menu" class="menu section">
      ...
      <div class="container section-title" data-aos="fade-up">
        <h2>Catalogo</h2>
        <p>Explora la diferentes categorias disponibles</p>
        ...
        <div class="isotope-layout" data-default-filter="*" data-layout="masonry" data-sort="original-order">
          ...
          <div class="menu-filters isotope-filters mb-5">
            <ul>
              ...
              <li data-filter=".filter-starters">Programacion</li>
              <li data-filter=".filter-main">Matematicas</li>
              <li data-filter=".filter-dessert">Fisica</li>
              <li data-filter=".filter-drinks">Varios</li>
            </ul>
          </div>
